package com.elastico.elasticsearch;
...
import elasticsearchclient.Company;
...
public class EsTest {
    ...
    public void setUp() throws UnknownHostException {
    	Company company1 = new Company(10, "John Doe", new Date());
    	Company company2 = new Company(25, "Janette Doe", new Date());
    ...
    public void givenSearchRequest_whenMatchAll_thenReturnAllResults() throws Exception {
        ...
        SearchHit[] searchHits = response.getHits()
            .getHits();
        List<Company> results = Arrays.stream(searchHits)
            .map(hit -> JSON.parseObject(hit.getSourceAsString(), Company.class))
    ...
    public void givenSearchParameters_thenReturnResults() throws Exception {
        ...
        final List<Company> results = Stream.of(response.getHits()
            .getHits(),
            response2.getHits()
                .getHits(),
            response3.getHits()
